...
* Added `getPopulation` to return genotypes for specific populations in a class `'genalex'` object
...
* New `ploidy` method to get the ploidy of an object of class `'genalex'`
